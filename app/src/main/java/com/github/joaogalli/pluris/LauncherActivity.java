        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LauncherActivity.this, "onAuthStateChanged:signed_in", Toast.LENGTH_SHORT).show();
                } else {
                    // User is signed out
                    Log.d(TAG, "onAuthStateChanged:signed_out");
                    Toast.makeText(LauncherActivity.this, "onAuthStateChanged:signed_out", Toast.LENGTH_SHORT).show();
                }
            }
        };
    }
